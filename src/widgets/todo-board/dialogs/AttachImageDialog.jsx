    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Выберите изображение для фона карточки</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          {selectedTodo?.backgroundImage && (
            <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
              ...
              <div className="relative w-full h-32 rounded-md overflow-hidden border border-gray-200 dark:border-gray-700">
                <img src={selectedTodo.backgroundImage} alt="Current background" className="w-full h-full object-cover" />
              </div>
              <Button variant="destructive" size="sm" className="mt-2 w-full" onClick={onRemoveBackground}>
          ...
          {imagePreview && (
            <div className="space-y-2">
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-md p-2">
                <img src={imagePreview} alt="Preview" className="max-w-full max-h-48 object-contain mx-auto rounded" />
              </div>
            </div>
          )}
          <div className="flex justify-end gap-2">
            ...
            <Button onClick={onSetBackground} disabled={!selectedImageFile}>
              Установить фон
            </Button>
          </div>
        </div>
